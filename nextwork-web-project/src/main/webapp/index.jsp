...
<title>Brian Kimemia N's GitHub Profile</title>
<style>
/* Global Styles */
body {
...
function toggleDarkMode() {
    ...
    <!-- Header -->
    <h2>For BETTER experience , toogle the Dark Mode button above ☑ </h2>
    <h1>Hi there, I'm Brian Kimemia Njeri! 👋</h1>

    <!-- Introduction -->
    <p class="intro">Welcome to my GitHub profile! I'm passionate about Data, Knowledge Management, Cybersecurity, and Cloud Technologies.</p>
...
<!-- Learning -->
<h2 style="text-align: center;">Currently Learning 🌱</h2>
<p style="text-align: center;">I'm currently diving deeper into Cloud Technologies!</p>

<!-- Collaboration -->
<h2 style="text-align: center;">Open to Collaboration 💼</h2>
<p style="text-align: center;">I'm open to collaborate on projects related to Data Analysis, Knowledge Management, and Cloud Solutions.</p>
...
<!-- Footer -->
<p style="text-align: center;">Feel free to explore my projects and connect with me! 😄</p>

<!-- Certifications & Digital Badges -->
<h2 style="text-align: center;">Certifications & Digital Badges🎓</h2>
...
<p style="text-align: center;">Click the badge to verify my AWS Certified Cloud Practitioner credential on Credly!</p>
...
<p style="text-align: center;">Click the badge to verify my Introduction to Data Science certification on Credly!</p>
...
<p style="text-align: center;">Click the badge to verify my Cybersecurity Essentials certification on Credly!</p>
...
<p style="text-align: center;">Click the badge to verify my Introduction to Cybersecurity certification on Credly!</p>
...
<p style="text-align: center;">Click the badge to verify my ISC2 Candidate Digital Badge on Credly!</p>
